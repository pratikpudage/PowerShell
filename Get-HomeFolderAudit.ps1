...
V1.10, 01/07/2021 - Added Home Folder time stamps in the report
...
$TargetOU = "OU=$Month,OU=Ex-Employees,DC=Domain,DC=com"
...
Import-Csv .\HomeFoldersAuditOutput.csv -Header HomeFolderStatus,SamAccountName,Description,ADAccountEnabled,HomeFolderPath,HomeFolderSize'(MB)',FolderCreationTime,FolderLastWriteTime,FolderLastAccessTime |Export-Csv .\HomeFoldersAuditOutputHeader.csv -NoTypeInformation
